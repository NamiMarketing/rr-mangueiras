        ...
        <div className={styles.bottomSection}>
          ...
          <div className={styles.socialAndCredits}>
            <div className={styles.socialIcons}>
              ...
              <a href="https://www.facebook.com/p/RR-Mangueiras-Curitiba-61573127075789/" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="25" cy="25" r="25" fill="white"/>
                  <path d="M39.1667 25.0002C39.1667 17.1802 32.82 10.8335 25 10.8335C17.18 10.8335 10.8334 17.1802 10.8334 25.0002C10.8334 31.8568 15.7067 37.566 22.1667 38.8835V29.2502H19.3334V25.0002H22.1667V21.4585C22.1667 18.7243 24.3909 16.5002 27.125 16.5002H30.6667V20.7502H27.8334C27.0542 20.7502 26.4167 21.3877 26.4167 22.1668V25.0002H30.6667V29.2502H26.4167V39.096C33.5709 38.3877 39.1667 32.3527 39.1667 25.0002Z" fill="#003340"/>
                </svg>
              </a>
            </div>
