...
const unidades: Unidade[] = [
  {
    ...
    telefone: '(41) 3569-3191 - Administrativo',
  ...
  },
  {
    ...
    telefone: '(41) 3606-5101 - Administrativo',
        ...
        <div className={styles.bottomSection}>
          ...
          <div className={styles.socialAndCredits}>
            <div className={styles.socialIcons}>
              <Link target="_blank" href="https://www.instagram.com/rrmangueiras" aria-label="Instagram">
              ...
              <Link target="_blank" href="https://www.facebook.com/profile.php?id=61573127075789" aria-label="Facebook">
                <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="25" cy="25" r="25" fill="white" />
                  <path d="M27.5 26.875H30.625L31.875 21.875H27.5V19.375C27.5 18.0875 27.5 16.875 30 16.875H31.875V12.675C31.4675 12.6212 29.929 12.5 28.304 12.5C24.9106 12.5 22.5 14.5712 22.5 18.375V21.875H18.75V26.875H22.5V37.5H27.5V26.875Z" fill="#003340" />
                </svg>
              </Link>
            </div>
